...
import com.google.android.apps.nexuslauncher.smartspace.b2.c;
import com.google.android.apps.nexuslauncher.smartspace.b2.e;
...
public class d
{
    ...
    private com.google.android.apps.nexuslauncher.smartspace.b2.d cG(final boolean b) {
        final c ch = this.cH();
        if (ch != null) {
            com.google.android.apps.nexuslauncher.smartspace.b2.d d;
            if (b) {
                d = ch.cL;
            }
            else {
    ...
    private boolean cL(final com.google.android.apps.nexuslauncher.smartspace.b2.d d) {
        boolean b = false;
    ...
    private String cO(final boolean b, final String s) {
        final com.google.android.apps.nexuslauncher.smartspace.b2.d cg = this.cG(b);
    ...
    static i cQ(final Context context, final a a) {
        ...
        i.dd = flattenBitmap;
        i.dc = false;//(cp != null && new com.google.android.apps.nexuslauncher.a.c().dB(cp));
        i.de = a.di;
        i.df = a.dl;
        if (a.dk != null) {
