...
public final class b extends a
{
    ...
    public static synchronized b[] emptyArray() {
        if (b.cI == null) {
            b.cI = new b[0];
        }
        return b.cI;
    ...
    public b mergeFrom(final com.google.protobuf.nano.c c) throws IOException {
        while (true) {
            final int ws = c.Ws();
            switch (ws) {
                default: {
    ...
    public void writeTo(final com.google.protobuf.nano.b b) throws IOException {
        final long n = 0L;
        if (this.cy) {
            b.VG(1, this.cy);
        }
