...
import com.google.android.apps.nexuslauncher.smartspace.b2.i;
...
public class f implements Handler.Callback
{
    ...
    private c dS;
    private final com.google.android.apps.nexuslauncher.a2.a dT;
    ...
    public f(final Context mAppContext) {
        ...
        this.dQ = new e();
        this.dT = new com.google.android.apps.nexuslauncher.a2.a(mAppContext);
    ...
    private Intent db() {
        return new Intent("com.google.android.apps.gsa.smartspace.SETTINGS").setPackage("com.google.android.googlequicksearchbox").addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
    }
    ...
    private void dc() {
        ...
        if (cs && (this.dQ.cS() ^ true)) {
            ...
            this.mAppContext.sendBroadcast(new Intent("com.google.android.apps.gsa.smartspace.EXPIRE_EVENT").setPackage("com.google.android.googlequicksearchbox").addFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
        }
    }
    ...
    private void de() {
        this.mAppContext.sendBroadcast(new Intent("com.google.android.apps.gsa.smartspace.ENABLE_UPDATE").setPackage("com.google.android.googlequicksearchbox").addFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
    }
    
    private void df(final a a, final SmartspaceController$Store smartspaceController$Store) {
