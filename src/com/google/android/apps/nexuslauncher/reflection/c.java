...
public class c implements Handler.Callback
{
    ...
    public void aC(final ComponentKey componentKey, final LauncherLogProto.LauncherEvent launcherLogProtoLauncherEvent) {
        Message.obtain(this.mMessageHandler, 2, Pair.create(componentKey, launcherLogProtoLauncherEvent)).sendToTarget();
    }
