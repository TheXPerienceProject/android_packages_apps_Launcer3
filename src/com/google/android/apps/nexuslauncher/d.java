...
public class d implements Launcher.LauncherOverlay, a
{
    ...
    public d(final Launcher mLauncher) {
        ...
        this.fP = Utilities.getDevicePrefs(mLauncher).getInt("pref_persistent_flags", 0);
        this.fO = false;
    }
    ...
    public void es(final int n) {
        ...
        if (fp != this.fP) {
            this.fO = true;
            this.fP = fp;
            Utilities.getDevicePrefs(this.mLauncher).edit().putInt("pref_persistent_flags", fp).apply();
        }
    }
