...
final class h implements ContentProvider.PipeDataWriter
{
    ...
    @Override
    public void writeDataToPipe(@NonNull ParcelFileDescriptor parcelFileDescriptor, @NonNull Uri uri, @NonNull String s, @Nullable Bundle bundle, @Nullable Object o) {
        //
