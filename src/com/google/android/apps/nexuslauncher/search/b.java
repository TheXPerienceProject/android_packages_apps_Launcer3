...
public class b implements SearchAlgorithm, Handler.Callback
{
    ...
    public void doSearch(final String s, final AllAppsSearchBarController.Callbacks allAppsSearchBarControllerCallbacks) {
        final int n = 100;
        this.eE.removeMessages(n);
        Message.obtain(this.eE, n, new c(s, allAppsSearchBarControllerCallbacks)).sendToTarget();
    }
