...
public final class c extends a
{
    public boolean eA;
    public int em;
    public com.google.android.apps.nexuslauncher.search.a2.a en;
    public b[] eo;
    public String ep;
    public boolean eq;
    public String er;
    public int es;
    public com.google.android.apps.nexuslauncher.search.a2.a et;
    public String eu;
    public com.google.android.apps.nexuslauncher.search.a2.a ev;
    public int ew;
    public int ex;
    public String ey;
    public com.google.android.apps.nexuslauncher.search.a2.a ez;
        ...
        while (true) {
            try {
                ...
                switch (ws) {
                    ...
                    case 34: {
                        if (this.en == null) {
                            this.en = new com.google.android.apps.nexuslauncher.search.a2.a();
                        }
                        c.Ww(this.en);
                        continue;
                    }
                    ...
                    case 58: {
                        if (this.ev == null) {
                            this.ev = new com.google.android.apps.nexuslauncher.search.a2.a();
                        }
                        c.Ww(this.ev);
                        continue;
                    }
                    ...
                    case 98: {
                        if (this.et == null) {
                            this.et = new com.google.android.apps.nexuslauncher.search.a2.a();
                        }
                        c.Ww(this.et);
                        continue;
                    }
                    ...
                    case 114: {
                        if (this.ez == null) {
                            this.ez = new com.google.android.apps.nexuslauncher.search.a2.a();
                        }
                        c.Ww(this.ez);
                        continue;
                    }
