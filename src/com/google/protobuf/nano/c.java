...
public final class c
{
    ...
    public byte WA() throws InvalidProtocolBufferNanoException {
        if (this.Pw == this.Px) {
    ...
    public String WB() throws InvalidProtocolBufferNanoException {
    ...
    public void WD(final int n) throws InvalidProtocolBufferNanoException {
        if (n < 0) {
    ...
    public int WF() throws InvalidProtocolBufferNanoException {
        return this.Wr();
    }
    
    public byte[] WG(final int n) throws InvalidProtocolBufferNanoException {
        if (n < 0) {
            throw InvalidProtocolBufferNanoException.Wf();
        }
        if (this.Pw + n > this.Py) {
    ...
    public float WH() throws InvalidProtocolBufferNanoException {
        return Float.intBitsToFloat(this.Wt());
    }
    
    public long WI() throws InvalidProtocolBufferNanoException {
        final long n = 255L;
        return (this.WA() & n) << 8 | (this.WA() & n) | (this.WA() & n) << 16 | (this.WA() & n) << 24 | (this.WA() & n) << 32 | (this.WA() & n) << 40 | (this.WA() & n) << 48 | (this.WA() & n) << 56;
    }
    
    public void WJ() throws InvalidProtocolBufferNanoException {
        int ws;
        do {
            ws = this.Ws();
    ...
    public void WK(final int n) throws InvalidProtocolBufferNanoException {
        if (this.PB != n) {
            throw InvalidProtocolBufferNanoException.Wk();
        }
    }
    
    public boolean WL(final int n) throws InvalidProtocolBufferNanoException {
    ...
    public int Wo(final int n) throws InvalidProtocolBufferNanoException {
        if (n < 0) {
            throw InvalidProtocolBufferNanoException.Wf();
        }
    ...
    public byte[] Wp() throws InvalidProtocolBufferNanoException {
        final int wr = this.Wr();
        if (wr <= this.Px - this.Pw && wr > 0) {
    ...
    public int Wr() throws InvalidProtocolBufferNanoException {
        int i = 0;
    ...
    public int Ws() throws InvalidProtocolBufferNanoException {
        if (this.Wm()) {
            return this.PB = 0;
        }
        this.PB = this.Wr();
    ...
    public int Wt() throws InvalidProtocolBufferNanoException {
        return (this.WA() & 0xFF) | (this.WA() & 0xFF) << 8 | (this.WA() & 0xFF) << 16 | (this.WA() & 0xFF) << 24;
    }
    
    public long Wu() throws InvalidProtocolBufferNanoException {
        int i = 0;
        long n = 0L;
        while (i < 64) {
            final byte wa = this.WA();
    ...
    public double Wv() throws InvalidProtocolBufferNanoException {
        return Double.longBitsToDouble(this.WI());
    }
    
    public void Ww(final a a) throws InvalidProtocolBufferNanoException {
        final int wr = this.Wr();
        if (this.PE >= this.PC) {
    ...
    public boolean Wy() throws InvalidProtocolBufferNanoException {
        boolean b = false;
        if (this.Wr() != 0) {
            b = true;
        }
    ...
    public long Wz() throws InvalidProtocolBufferNanoException {
        return this.Wu();
    }
}
