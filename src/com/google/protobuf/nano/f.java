...
public final class f
{
    ...
    public static final int WN(final c c, final int n) throws InvalidProtocolBufferNanoException {
        int n2 = 1;
        final int wn = c.Wn();
        c.WL(n);
        while (c.Ws() == n) {
    ...
    public static boolean WR(final c c, final int n) throws InvalidProtocolBufferNanoException {
        return c.WL(n);
    }
}
