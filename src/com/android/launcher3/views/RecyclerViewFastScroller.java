...
public class RecyclerViewFastScroller extends View
{
    ...
    public RecyclerViewFastScroller(final Context context, final AttributeSet set, final int n) {
        ...
        final int dimensionPixelSize = resources.getDimensionPixelSize(R.dimen.fastscroll_track_min_width);
    ...
    public void onDraw(final Canvas canvas) {
        ...
        final int save = canvas.save(Canvas.MATRIX_SAVE_FLAG);
    ...
    public void setRecyclerView(final BaseRecyclerView mRv, final TextView mPopupView) {
        (this.mRv = mRv).addOnScrollListener(new RecyclerViewFastScroller2(this));
    ...
    public boolean shouldBlockIntercept(final int n, final int n2) {
     ...
     static final class RecyclerViewFastScroller$1 extends Property
    {
    ...
    final class RecyclerViewFastScroller2 extends android.support.v7.widget.RecyclerView.OnScrollListener
    {
        final /* synthetic */ RecyclerViewFastScroller this$0;

        RecyclerViewFastScroller2(final RecyclerViewFastScroller this$0) {
            this.this$0 = this$0;
        }
