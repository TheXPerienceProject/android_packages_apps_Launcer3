...
public abstract class BaseRecyclerView extends RecyclerView
    ...
    protected void onAttachedToWindow() {
        ...
        mScrollbar = viewGroup.findViewById(R.id.fast_scroller);
        mScrollbar.setRecyclerView(this, (TextView)viewGroup.findViewById(R.id.fast_scroller_popup));
    ...
    private boolean handleTouchEvent(MotionEvent ev) {
        int n = this.getLeft() - this.mScrollbar.getLeft();
        int n2 = this.getTop() - this.mScrollbar.getTop();
        ev.offsetLocation((float)n, (float)n2);
        try {
            return this.mScrollbar.handleTouchEvent(ev);
        } finally {
            ev.offsetLocation((float)(-n), (float)(-n2));
        }
    }
    ...
    public abstract String scrollToPositionAtProgress(float progress);
}