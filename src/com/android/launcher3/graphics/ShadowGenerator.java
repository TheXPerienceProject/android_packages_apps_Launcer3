...
public class ShadowGenerator {
    ...
    public static class Builder
    {
        ...
        public void drawShadow(final Canvas canvas) {
            final int n = -0x1000000;
            final Paint paint = new Paint(3);
            paint.setColor(this.color);
            paint.setShadowLayer(this.shadowBlur, 0.0f, this.keyShadowDistance, ColorUtils.setAlphaComponent(n, this.keyShadowAlpha));
            canvas.drawRoundRect(this.bounds, this.radius, this.radius, paint);
            paint.setShadowLayer(this.shadowBlur, 0.0f, 0.0f, ColorUtils.setAlphaComponent(n, this.ambientShadowAlpha));
            canvas.drawRoundRect(this.bounds, this.radius, this.radius, paint);
        }
