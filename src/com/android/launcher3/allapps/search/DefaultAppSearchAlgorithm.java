...
public class DefaultAppSearchAlgorithm implements SearchAlgorithm
{
    ...
    public DefaultAppSearchAlgorithm(final List<AppInfo> mApps) {
        this.mApps = mApps;
    ...
    public void doSearch(final String s, final AllAppsSearchBarController.Callbacks callbacks) {
        this.mResultHandler.post((Runnable)new DefaultAppSearchAlgorithm$1(this, callbacks, s, this.getTitleMatchResult(s)));
    }
}
